        ...
        <div class="flex flex-col">
            ...
            <div class="mt-5 flex flex-col gap-2 text-sm sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-4 sm:gap-y-1">
                ...
                <a href="https://www.facebook.com/share/1BaUfp47Gd/"
                   ...
                   class="inline-flex items-center justify-center shadow-sm transition focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
                   style="display: inline-flex; width: 2.25rem; height: 2.25rem; flex: 0 0 2.25rem; align-items: center; justify-content: center; border-radius: 9999px; background-color: #1877f2; color: #ffffff;">
                    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="display: block; width: 1.25rem; height: 1.25rem;">
